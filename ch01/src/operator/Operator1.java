...
public class Operator1 {
	...
	public static void main(String[] args) {
		...
		// int로 연산시 int형이 되므로 자료의 손실이 생김(87.5가 87로 표시), double로 형변환
		...
		// val = num++;	// 후치연산 계산 순서 1. num을 val에 저장, 2. num=num+1 1증가
		val = ++num;	// 전치연산 계산 순서 1. num=num+1 1증가, 2. num을 val에 저장 (num도 변함)
