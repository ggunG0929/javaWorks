...
public class ArrayList1 {
	...
	public static void main(String[] args) {
		...
		// 요소 삭제 - remove()
//		cartList.remove(1);
//		cartList.remove("콩나물");	// 인덱스 사용하지 않고 직접 객체 입력
		if(cartList.contains("콩나물"))	// contains() - 객체를 포함한다, 인덱스가 없으면 예외 발생되므로 contains를 사용권장(임의로 인덱스를 주는 기능인 듯?)
			cartList.remove("콩나물");
//		if(cartList.contains(cartList.get(2)))	// 인덱스 번호 삭제
//			cartList.remove(2);
